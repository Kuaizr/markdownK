    ...
    menu.onclick = e => {
        ...
        switch (id) {
            ...
            case "EditInVscode":
                ...
                break;
            case "Outline":
                let flag = document.getElementsByClassName('vditor-outline')[0].style.display
                if(flag == 'none'){
                    window.editor.vditor.outline.toggle(window.editor.vditor, true);
                }else{
                    window.editor.vditor.outline.toggle(window.editor.vditor, false);
                }
                break;
        }
    }
