!function(e, t) {
    ...
    var e = {
            ...
            t.prototype.diff_bisect_ = function(e, r, i) {
                ...
                for (var m = o - a, f = m % 2 != 0, h = 0, v = 0, g = 0, y = 0, b = 0; b < l && !((new Date).getTime() > i); b++) {
                    for (var w = -b + h; w <= b - v; w += 2) {
                        for (var E = s + w, k = (T = w == -b || w != b && c[E - 1] < c[E + 1] ? c[E + 1] : c[E - 1] + 1) - w; T < o && k < a && e.charAt(T) == r.charAt(k); )
                            T++,
                            k++;
                        if (c[E] = T,
                        T > o)
                            ...
                            if ((C = s + m - w) >= 0 && C < d && -1 != u[C])
                                if (T >= (L = o - u[C]))
                                    return this.diff_bisectSplit_(e, r, T, k, i)
                        }
                    }
                    for (var S = -b + g; S <= b - y; S += 2) {
                        for (var L, C = s + S, M = (L = S == -b || S != b && u[C - 1] < u[C + 1] ? u[C + 1] : u[C - 1] + 1) - S; L < o && M < a && e.charAt(o - L - 1) == r.charAt(a - M - 1); )
                            L++,
                            M++;
                        if (u[C] = L,
                        L > o)
            ...
            var r = n(369)
              ...
              , C = function(e, t) {
                ...
                "undefined" != typeof speechSynthesis && "undefined" != typeof SpeechSynthesisUtterance) {
                    ...
                    document.getElementById("vditorIconScript") || (n = '<svg viewBox="0 0 32 32"><path d="M3.436 0l25.128 16-25.128 16v-32z"></path></svg>',
                    r = '<svg viewBox="0 0 32 32"><path d="M20.617 0h9.128v32h-9.128v-32zM2.255 32v-32h9.128v32h-9.128z"></path></svg>');
                    ...
                    if (!i) {
                        ...
                        i.onclick = function() {
                            if ("vditor-speech" === i.className) {
                                ...
                                speechSynthesis.speaking && (speechSynthesis.paused ? (speechSynthesis.resume(),
                                i.innerHTML = r) : (speechSynthesis.pause(),
                                i.innerHTML = n));
                            (0,
                        ...
                        document.body.addEventListener("click", (function() {
                            "" === getSelection().toString().trim() && "block" === i.style.display && (i.className = "vditor-speech",
                            speechSynthesis.cancel(),
                    ...
                    e.addEventListener("mouseup", (function(e) {
                        ...
                        "" !== getSelection().toString().trim()) {
                            ...
                            "block" === i.style.display && (i.className = "vditor-speech",
                            i.style.display = "none")
                    }
                    ))
                }
              ...
              , _ = function(e, t) {
                var n = A(t);
                return (0,
                w.G)(n.cdn + "/dist/js/lute/lute.min.js", "vditorLuteScript").then((function() {
                    var r = (0,
                    S.X)({
                ...
                return M(void 0, void 0, void 0, (function() {
                    ...
                    return T(this, (function(S) {
                        ...
                        case 1:
                            ...
                            i.i18n)
                                return [3, 5];
                            if (["en_US", "ja_JP", "ko_KR", "ru_RU", "zh_CN", "zh_TW"].includes(i.lang))
                                return [3, 2];
                            throw new Error("options.lang error, see https://ld246.com/article/1549638745630#options");
                        case 2:
                            return k = (y = "vditorI18nScript") + i.lang,
                            document.querySelectorAll('head script[id^="' + y + '"]').forEach((function(e) {
                                e.id !== k && document.head.removeChild(e)
                            }
                            )),
                            [4, (0,
                            w.G)(i.cdn + "/dist/js/i18n/" + i.lang + ".js", k)];
                        case 3:
                            S.sent(),
                            S.label = 4;
                        case 4:
                        ...
                        case 8:
                            ...
                            p.Y)(e),
                            i.speech.enable && C(e),
                            0 !== i.anchor && (L = i.anchor,
                            document.querySelectorAll(".vditor-anchor").forEach((function(e) {
                                1 === L && e.classList.add("vditor-anchor--left"),
                                e.onclick = function() {
              ...
              , i = function(e) {
                e.querySelectorAll("pre > code").forEach((function(t, n) {
                    ...
                    if (!t.parentElement.classList.contains("vditor-wysiwyg__pre") && !t.parentElement.classList.contains("vditor-ir__marker--pre") && !(t.classList.contains("language-mermaid") || t.classList.contains("language-flowchart") || t.classList.contains("language-echarts") || t.classList.contains("language-mindmap") || t.classList.contains("language-plantuml") || t.classList.contains("language-markmap") || t.classList.contains("language-abc") || t.classList.contains("language-graphviz") || t.classList.contains("language-math") || t.style.maxHeight.indexOf("px") > -1 || e.classList.contains("vditor-preview") && n > 5)) {
                        ...
                        c.innerHTML = '<span aria-label="' + ((null === (i = window.VditorI18n) || void 0 === i ? void 0 : i.copy) || "复制") + "\"\nonmouseover=\"this.setAttribute('aria-label', '" + ((null === (o = window.VditorI18n) || void 0 === o ? void 0 : o.copy) || "复制") + "')\"\nclass=\"vditor-tooltipped vditor-tooltipped__w\"\nonclick=\"this.previousElementSibling.select();document.execCommand('copy');this.setAttribute('aria-label', '" + ((null === (a = window.VditorI18n) || void 0 === a ? void 0 : a.copy) || "已复制") + "')\">" + d + "</span>";
                        var u = document.createElement("textarea");
                        u.value = (0,
                        r.X)(l),
                        c.insertAdjacentElement("afterbegin", u),
                        t.before(c),
                        t.style.maxHeight = window.outerHeight - 40 + "px"
                    }
                }
                ))
            }
                    ...
                    i.G)(n + "/dist/js/highlight.js/solidity.min.js", "vditorHljsSolidityScript").then((function() {
                        ...
                        i.G)(n + "/dist/js/highlight.js/yul.min.js", "vditorHljsYulScript").then((function() {
                            t.querySelectorAll("pre > code").forEach((function(t) {
                                if (!t.parentElement.classList.contains("vditor-ir__marker--pre") && !t.parentElement.classList.contains("vditor-wysiwyg__pre") && !(t.classList.contains("language-mermaid") || t.classList.contains("language-flowchart") || t.classList.contains("language-echarts") || t.classList.contains("language-mindmap") || t.classList.contains("language-plantuml") || t.classList.contains("language-markmap") || t.classList.contains("language-abc") || t.classList.contains("language-graphviz") || t.classList.contains("language-math")) && (hljs.highlightElement(t),
                                e.lineNumber)) {
        ...
        30: (e,t,n)=>{
            ...
            var r = n(260)
              ...
              , a = {}
              , l = function(e, t) {
                var n = markmap.Transformer
                  , r = markmap.Markmap
                  , i = markmap.deriveOptions
                  , o = new n;
                ...
                var l = e.firstChild
                  ...
                  , d = function(e, t) {
                    ...
                    var i = e.getAssets(r)
                      , o = i.styles
                      , l = i.scripts;
                    return o && markmap.loadCSS(o),
                    l && markmap.loadJS(l),
                    n
                }(o, t)
                  , c = d.root
                  , u = d.frontmatter
                  , p = i(null == u ? void 0 : u.markmap);
                s.setData(c, p),
                s.fit()
            }
              , s = function(e, t, n) {
                ...
                0 !== a.length && (0,
                i.G)(t + "/dist/js/markmap/markmap.min.js", "vditorMarkmapScript").then((function() {
                    a.forEach((function(e) {
              ...
              , s = function(e, t) {
                ...
                if (0 !== n.length) {
                    ...
                    "KaTeX" === (t = Object.assign({}, s, t)).math.engine)
                        (0,
                        o.c)(t.cdn + "/dist/js/katex/katex.min.css", "vditorKatexStyle"),
                        (0,
                        i.G)(t.cdn + "/dist/js/katex/katex.min.js", "vditorKatexScript").then((function() {
                            (0,
                            i.G)(t.cdn + "/dist/js/katex/mhchem.min.js", "vditorKatexChemScript").then((function() {
                                n.forEach((function(e) {
            ...
            var r = function(e) {
                e && e.querySelectorAll("a").forEach((function(e) {
                    ...
                    t && (t.match(/^.+.(mp4|m4v|ogg|ogv|webm)$/) ? function(e, t) {
                        ...
                        n && 11 === n[1].length ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//www.youtube.com/embed/' + n[1] + (n[2] ? "?start=" + n[2] : "") + '"></iframe>'),
                        e.remove()) : r && r[1] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//player.youku.com/embed/' + r[1] + '"></iframe>'),
                        e.remove()) : i && i[1] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="https://v.qq.com/txp/iframe/player.html?vid=' + i[1] + '"></iframe>'),
                        e.remove()) : o && o[1] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video"\n src="//coub.com/embed/' + o[1] + '?muted=false&autostart=false&originalSize=true&startWithHD=true"></iframe>'),
                        e.remove()) : a && a[0] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video"\n src="https://www.facebook.com/plugins/video.php?href=' + encodeURIComponent(a[0]) + '"></iframe>'),
                        e.remove()) : l && l[2] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video"\n src="https://www.dailymotion.com/embed/video/' + l[2] + '"></iframe>'),
                        e.remove()) : s && s[1] ? (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video"\n src="//player.bilibili.com/player.html?bvid=' + s[1] + '"></iframe>'),
                        e.remove()) : d && d[1] && (e.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//embed.ted.com/talks/' + d[1] + '"></iframe>'),
                        e.remove())
                    }(e, t))
                }
                ))
              ...
              , a = function(e, t, n) {
                ...
                i.G)(t + "/dist/js/mermaid/mermaid.min.js", "vditorMermaidScript").then((function() {
                    ...
                    a.forEach((function(e) {
                        ...
                        "true" !== e.getAttribute("data-processed") && "" !== t.trim() && (mermaid.init(void 0, e),
                        e.setAttribute("data-processed", "true"))
                    }
                    ))
                }
        ...
        228: (e,t,n)=>{
            ...
            var r = function(e, t) {
                ...
                r.text = `document.body.insertAdjacentHTML('afterBegin', \`<svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <defs>
    ...
    return (()=>{
        ...
        var e, t = n(857), i = n(260), o = n(769), a = function(e) {
        ...
        }, y = n(713), b = n(615), w = function(e, t, n, r) {
            r && console.log(e + " - " + n + ": " + t)
        }, E = n(369), k = n(726), S = n(23), L = n(383), C = n(890), M = n(93), T = n(323), A = n(765), _ = n(30), x = n(894), H = n(583), N = function(e, t) {
            if (e)
                if ("html-block" !== e.parentElement.getAttribute("data-type")) {
                    var n = e.firstElementChild.className.replace("language-", "");
                    n && ("abc" === n ? (0,
                    E.Q)(e, t.options.cdn) : "mermaid" === n ? (0,
                    A.i)(e, t.options.cdn, t.options.theme) : "markmap" === n ? (0,
                    _.K)(e, t.options.cdn, t.options.theme) : "flowchart" === n ? (0,
                    L.P)(e, t.options.cdn) : "echarts" === n ? (0,
                    k.p)(e, t.options.cdn, t.options.theme) : "mindmap" === n ? (0,
                    x.P)(e, t.options.cdn, t.options.theme) : "plantuml" === n ? (0,
                    H.B)(e, t.options.cdn) : "graphviz" === n ? (0,
                    C.v)(e, t.options.cdn) : "math" === n ? (0,
                    T.H)(e, {
                        cdn: t.options.cdn,
            ...
            if (e.previousElementSibling && e.previousElementSibling.classList.contains("vditor-toc")) {
                ...
                D.im)(e, t[t.currentMode].element, r).start)
                    ...
                    st(t),
                    !0;
                if (tt(t, n, r, e, e.previousElementSibling))
                    return !0
            }
            if (e.nextElementSibling && e.nextElementSibling.classList.contains("vditor-toc")) {
                ...
                D.im)(e, t[t.currentMode].element, r).start >= e.textContent.trimRight().length)
                    ...
                    st(t),
                    !0;
                if (et(t, n, r, e, e.nextElementSibling))
                    return !0
            }
            ...
            if (o && !n && "code-block" !== o.getAttribute("data-type")) {
                if (at(o.innerHTML) && o.previousElementSibling || lt(o.innerHTML))
                    return;
                for (var l = (0,
            ...
            h) {
                ...
                if (L) {
                    var C = L.textContent
                      , M = C.substring(1, C.indexOf("]:"))
                      , T = e.ir.element.querySelector('sup[data-type="footnotes-ref"][data-footnotes-label="' + M + '"]');
                    T && T.setAttribute("aria-label", C.substr(M.length + 3).trim().substr(0, 24))
                }
            }
            ...
            if (o && "$$" === o.textContent.trimRight())
                ...
                v ? h = o.textContent : (o.previousElementSibling && (h = o.previousElementSibling.textContent + h,
                o.previousElementSibling.remove()),
                o.previousElementSibling && 0 === h.indexOf("---\n") && (h = o.previousElementSibling.textContent + h,
                o.previousElementSibling.remove()),
                o.innerText.startsWith("```") || (e.sv.element.querySelectorAll("[data-type='link-ref-defs-block']").forEach((function(e, t) {
                ...
                h = Ne(h, e),
                v ? o.innerHTML = h : o.outerHTML = h;
                var g, b = e.sv.element.querySelectorAll("[data-type='link-ref-defs-block']");
                b.forEach((function(e, t) {
                    0 === t ? f = e.parentElement : (f.lastElementChild.remove(),
                    f.insertAdjacentHTML("beforeend", "" + e.parentElement.innerHTML),
                    e.parentElement.remove())
                }
                )),
                ...
                w.forEach((function(e, t) {
                    0 === t ? g = e.parentElement : (g.lastElementChild.remove(),
                    g.insertAdjacentHTML("beforeend", "" + e.parentElement.innerHTML),
                    e.parentElement.remove())
                }
                )),
                w.length > 0 && e.sv.element.insertAdjacentElement("beforeend", g),
                (0,
                D.ib)(e.sv.element, r),
                Te(e),
                Oe(e, {
        ...
        var F, Z, J = function(t) {
            ...
            (0,
            D.Hc)(i),
            e.firstElementChild.classList.contains("language-mindmap") || Te(t)
        }, ie = function(e, t) {
            if (P("⇧⌘X", t)) {
            ...
            e.wysiwyg.hlToolbarTimeoutId = window.setTimeout((function() {
                ...
                D.Gb)(e.wysiwyg.element)) {
                    ...
                    u(e.toolbar.elements, ["inline-code"])) : v ? (m(e.toolbar.elements, ["bold"]),
                    u(e.toolbar.elements, ["headings"])) : h && m(e.toolbar.elements, ["table"]);
                    var g = (0,
                    y.fb)(n, "vditor-toc");
                    if (g)
                        return e.wysiwyg.popover.innerHTML = "",
                    ...
                    var w = (0,
                    b.S)(n, "BLOCKQUOTE");
                    if (w && (e.wysiwyg.popover.innerHTML = "",
                    se(t, w, e),
                    de(t, w, e),
                    ce(w, e),
                    ae(e, w)),
                    ...
                    h) {
                        ...
                        var E = function() {
                            var e = h.rows.length
                              , t = h.rows[0].cells.length
                              , n = parseInt(R.value, 10) || e
                              , r = parseInt(q.value, 10) || t;
                            if (n !== e || t !== r) {
                                if (t !== r)
                                    for (var i = r - t, o = 0; o < h.rows.length; o++)
                                        if (i > 0)
                                            for (var a = 0; a < i; a++)
                                                0 === o ? h.rows[o].lastElementChild.insertAdjacentHTML("afterend", "<th> </th>") : h.rows[o].lastElementChild.insertAdjacentHTML("afterend", "<td> </td>");
                                        else
                                            for (var l = t - 1; l >= r; l--)
                                                h.rows[o].cells[l].remove();
                                if (e !== n) {
                                    var s = n - e;
                                    if (s > 0) {
                                        for (var d = "<tr>", c = 0; c < r; c++)
                                            d += "<td> </td>";
                                        for (var u = 0; u < s; u++)
                                            h.querySelector("tbody") ? h.querySelector("tbody").insertAdjacentHTML("beforeend", d) : h.querySelector("thead").insertAdjacentHTML("afterend", d + "</tr>")
                                    } else
                                        for (c = e - 1; c >= n; c--)
                                            h.rows[c].remove(),
                                            1 === h.rows.length && h.querySelector("tbody").remove()
                                }
                            }
                        }
                          , k = function(n) {
                            ...
                            T.classList.add("vditor-icon--current")) : (T.classList.remove("vditor-icon--current"),
                            A.classList.remove("vditor-icon--current"),
                        ...
                        T.setAttribute("aria-label", window.VditorI18n.alignCenter + "<" + (0,
                        d.ns)("⇧⌘C") + ">"),
                        T.setAttribute("data-type", "center"),
                        T.innerHTML = '<svg><use xlink:href="#vditor-icon-align-center"></use></svg>',
                        T.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n" + ("center" === C ? " vditor-icon--current" : ""),
                        T.onclick = function() {
                            k("center")
                        }
                        ;
                        ...
                        x.setAttribute("aria-label", window.VditorI18n.insertRowAbove + "<" + (0,
                        d.ns)("⇧⌘F") + ">"),
                        x.setAttribute("data-type", "insertRow"),
                        x.innerHTML = '<svg><use xlink:href="#vditor-icon-insert-rowb"></use></svg>',
                        ...
                        H.setAttribute("aria-label", window.VditorI18n.insertColumnRight + "<" + (0,
                        d.ns)("⇧⌘=") + ">"),
                        H.setAttribute("data-type", "insertColumn"),
                        H.innerHTML = '<svg><use xlink:href="#vditor-icon-insert-column"></use></svg>',
                        ...
                        O.setAttribute("aria-label", window.VditorI18n.insertColumnLeft + "<" + (0,
                        d.ns)("⇧⌘G") + ">"),
                        O.setAttribute("data-type", "insertColumn"),
                        O.innerHTML = '<svg><use xlink:href="#vditor-icon-insert-columnb"></use></svg>',
                        ...
                        O.onclick = function() {
                            ...
                            y.lG)(t, "TD") || (0,
                            y.lG)(t, "TH");
                            n && ft(e, h, n, "beforebegin")
                        }
                        ;
                        var I = document.createElement("button");
                        I.setAttribute("type", "button"),
                        I.setAttribute("aria-label", window.VditorI18n["delete-row"] + "<" + (0,
                        d.ns)("⌘-") + ">"),
                        I.setAttribute("data-type", "deleteRow"),
                        I.innerHTML = '<svg><use xlink:href="#vditor-icon-delete-row"></use></svg>',
                        ...
                        j.setAttribute("aria-label", window.VditorI18n["delete-column"] + "<" + (0,
                        d.ns)("⇧⌘-") + ">"),
                        j.setAttribute("data-type", "deleteColumn"),
                        j.innerHTML = '<svg><use xlink:href="#vditor-icon-delete-column"></use></svg>',
                        ...
                        ,
                        (Z = document.createElement("span")).setAttribute("aria-label", window.VditorI18n.row),
                        ...
                        R.value = h.rows.length.toString(),
                        R.oninput = function() {
                            E()
                        }
                        ,
                        R.onkeydown = function(t) {
                            if (!t.isComposing)
                                return "Tab" === t.key ? (q.focus(),
                                q.select(),
                                void t.preventDefault()) : void ie(e, t)
                        }
                        ;
                        var P = document.createElement("span");
                        P.setAttribute("aria-label", window.VditorI18n.column),
                        P.className = "vditor-tooltipped vditor-tooltipped__n";
                        ...
                        q.setAttribute("placeholder", window.VditorI18n.column),
                        q.value = h.rows[0].cells.length.toString(),
                        q.oninput = function() {
                            E()
                        }
                        ,
                    ...
                    if (V) {
                        ...
                        e.options;
                        e.wysiwyg.popover.innerHTML = "",
                        (Z = document.createElement("span")).setAttribute("aria-label", window.VditorI18n.footnoteRef + "<" + (0,
                        d.ns)("⌥Enter") + ">"),
                        Z.className = "vditor-tooltipped vditor-tooltipped__n";
                        var U = document.createElement("input");
                        Z.appendChild(U),
                        U.className = "vditor-input",
                        U.setAttribute("placeholder", window.VditorI18n.footnoteRef + "<" + (0,
                        d.ns)("⌥Enter") + ">"),
                        U.style.width = "120px",
                        ...
                        U.onkeydown = function(n) {
                            if (!n.isComposing)
                                return (0,
                                d.yl)(n) || n.shiftKey || !n.altKey || "Enter" !== n.key ? void ie(e, n) : (t.selectNodeContents(V),
                                t.collapse(!1),
                                (0,
                                D.Hc)(t),
                    ...
                    y.fb)(n, "vditor-wysiwyg__block")
                      , K = !!W && W.getAttribute("data-type").indexOf("block") > -1;
                    if (e.wysiwyg.element.querySelectorAll(".vditor-wysiwyg__preview").forEach((function(e) {
                        (!W || W && K && !W.contains(e)) && (e.previousElementSibling.style.display = "none")
                    }
                    )),
                    W && K) {
                        ...
                        "code-block" === W.getAttribute("data-type")) {
                            ...
                            z.setAttribute("aria-label", window.VditorI18n.language + "<" + (0,
                            d.ns)("⌥Enter") + ">"),
                            z.className = "vditor-tooltipped vditor-tooltipped__n";
                            ...
                            G.setAttribute("placeholder", window.VditorI18n.language + "<" + (0,
                            d.ns)("⌥Enter") + ">"),
                            G.value = F.className.indexOf("language-") > -1 ? F.className.split("-")[1].split(" ")[0] : "",
                            G.oninput = function(n) {
                                "" !== G.value.trim() ? F.className = "language-" + G.value : (F.className = "",
                                e.hint.recentLanguage = ""),
                                W.lastElementChild.classList.contains("vditor-wysiwyg__preview") && (W.lastElementChild.innerHTML = W.firstElementChild.innerHTML,
                                N(W.lastElementChild, e)),
                                Y(e),
                                1 === n.detail && (t.setStart(F.firstChild, 0),
                                t.collapse(!0),
                                (0,
                                D.Hc)(t))
                            }
                            ,
                            G.onkeydown = function(n) {
                                if (!n.isComposing && !ie(e, n)) {
                                    ...
                                    e.hint.select(n, e),
                                    (0,
                                    d.yl)(n) || n.shiftKey || "Enter" !== n.key || (t.setStart(F.firstChild, 0),
                                    t.collapse(!0),
                                    (0,
                                    D.Hc)(t),
                                    n.preventDefault(),
                            ...
                            G.onkeyup = function(t) {
                                if (!t.isComposing && "Enter" !== t.key && "ArrowUp" !== t.key && "Escape" !== t.key && "ArrowDown" !== t.key) {
                                    var n = []
                                      , r = G.value.substring(0, G.selectionStart);
                    ...
                    if (v) {
                        var Z;
                        e.wysiwyg.popover.innerHTML = "",
                        (Z = document.createElement("span")).setAttribute("aria-label", "ID<" + (0,
                        d.ns)("⌥Enter") + ">"),
                        Z.className = "vditor-tooltipped vditor-tooltipped__n";
                        var J = document.createElement("input");
                        Z.appendChild(J),
                        J.className = "vditor-input",
                        J.setAttribute("placeholder", "ID<" + (0,
                        d.ns)("⌥Enter") + ">"),
                        J.style.width = "120px",
                    ...
                    !(w || o || h || W || f || B || V || v || g)) {
                        var X = (0,
                        y.a1)(n, "data-block", "0");
                        X && X.parentElement.isEqualNode(e.wysiwyg.element) ? (e.wysiwyg.popover.innerHTML = "",
                        se(t, X, e),
                        de(t, X, e),
                        ce(X, e),
                        ae(e, X)) : e.wysiwyg.popover.style.display = "none"
                    }
            ...
            i.setAttribute("placeholder", window.VditorI18n.textIsNotEmpty),
            i.style.width = "120px",
            ...
            o.setAttribute("aria-label", window.VditorI18n.linkRef),
            o.className = "vditor-tooltipped vditor-tooltipped__n";
            var a = document.createElement("input");
            o.appendChild(a),
            a.className = "vditor-input",
            a.setAttribute("placeholder", window.VditorI18n.linkRef),
            ...
            ;
            var o = document.createElement("span");
            o.setAttribute("aria-label", window.VditorI18n.link),
            o.className = "vditor-tooltipped vditor-tooltipped__n";
            var a = document.createElement("input");
            o.appendChild(a),
            a.className = "vditor-input",
            a.setAttribute("placeholder", window.VditorI18n.link),
            ...
            for (var r = e.startContainer.parentElement, o = !1, a = "", l = "", s = function(e) {
                ...
                "S" === u || "STRONG" === u || "EM" === u) {
                    var p = ""
                      , m = ""
                      , f = "";
                    "0" !== r.parentElement.getAttribute("data-block") && (m = $(r),
                    f = Q(r)),
                    (d || m) && (d = p = m + "<" + u + ">" + d + "</" + u + ">"),
            ...
            d.Le)(), (function(n) {
                    ...
                    if (!(e.wysiwyg.composingLock && n instanceof CustomEvent)) {
                        ...
                        if (t.classList.contains("vditor-menu--current"))
                            ...
                            "quote" === l) {
                                ...
                                document.execCommand("unlink", !1, "")) : document.execCommand("unlink", !1, "") : "check" === l || "list" === l || "ordered-list" === l ? (nt(e, a, l),
                                (0,
                                D.ib)(e.wysiwyg.element, a),
                                r = !1,
                                t.classList.remove("vditor-menu--current")) : (r = !1,
                                t.classList.remove("vditor-menu--current"),
                                "" === a.toString() ? he(a, e, l) : document.execCommand(l, !1, ""));
                        else {
                ...
                }(e, r.element.children[0], n) : "ir" === e.currentMode ? _t(e, r.element.children[0], t.prefix || "", t.suffix || "") : je(e, r.element.children[0], t.prefix || "", t.suffix || ""))
            }
            ))
        }, ge = (F = function(e, t) {
        ...
        function(e, t) {
            ...
            e.currentMode !== t || "string" == typeof n) {
                ...
                e.outline.toggle(e, "sv" !== e.currentMode && e.options.outline.enable)
            }
        }, be = function(e) {
            function t(t, n) {
            ...
            t.addEventListener("drop", (function(t) {
                t.dataTransfer.getData(i.g.DROP_EDITOR) ? st(e) : (t.dataTransfer.types.includes("Files") || t.dataTransfer.types.includes("text/html")) && Lt(e, t, {
                ...
                if (!(e.options.hint.extend.length > 1 || e.toolbar.elements.emoji) || !e.hint.select(t, e)) {
                    ...
                    "sv" === e.currentMode) {
                        if (function(e, t) {
                            ...
                            d.yl)(t) && !t.altKey && !t.shiftKey && w) {
                                ...
                                l.collapse(!1),
                                w && "" !== w.textContent.trim() && !k ? V(e) : Oe(e),
                                t.preventDefault(),
                                !0
                            }
                            ...
                            d.yl)(t) && !t.altKey && !t.shiftKey) {
                                ...
                                D.im)(w, e.sv.element, l).start && w.previousElementSibling) {
                                    ...
                                    return "newline" === C.getAttribute("data-type") && (C.remove(),
                                    C = w.previousElementSibling.lastElementChild),
                                    "newline" !== C.getAttribute("data-type") && (C.insertAdjacentHTML("afterend", w.innerHTML),
                                    w.remove()),
                                    "" === w.textContent.trim() || (null === (a = w.previousElementSibling) || void 0 === a ? void 0 : a.querySelector('[data-type="code-block-open-marker"]')) ? ("newline" !== C.getAttribute("data-type") && (l.selectNodeContents(C.lastChild),
                                    l.collapse(!1)),
                                    Oe(e)) : V(e),
                                    t.preventDefault(),
                                    !0
                        ...
                        if (function(e, t) {
                            ...
                            if (l) {
                                ...
                                if ("0" === l.getAttribute("data-block")) {
                                    if (yt(e, t, l.firstElementChild, n))
                                        return !0;
                                    if (et(e, t, n, l.firstElementChild, l))
                                        return !0;
                                    if ("yaml-front-matter" !== l.getAttribute("data-type") && tt(e, t, n, l.firstElementChild, l))
                                        return !0
                                }
                            }
                            if (bt(e, n, t, a))
                            ...
                            if (m) {
                                ...
                                var h;
                                if (P("⌘=", t))
                                    return (h = parseInt(m.tagName.substr(1), 10) - 1) > 0 && (te(e, "h" + h),
                                    Y(e)),
                                    t.preventDefault(),
                                    !0;
                                if (P("⌘-", t))
                                    return (h = parseInt(m.tagName.substr(1), 10) + 1) < 7 && (te(e, "h" + h),
                                    Y(e)),
                                    t.preventDefault(),
                                    !0;
                                "Backspace" !== t.key || (0,
                                d.yl)(t) || t.shiftKey || t.altKey || 1 !== m.textContent.length || ne(e)
                            }
                            if (wt(e, n, t))
                                return !0;
                                ...
                                if (o) {
                                    if (o.previousElementSibling && o.previousElementSibling.classList.contains("vditor-wysiwyg__block") && "0" === o.previousElementSibling.getAttribute("data-block") && "UL" !== o.tagName && "OL" !== o.tagName) {
                                        ...
                                        if (0 === k && 0 === n.startOffset || 1 === k && o.innerText.startsWith(i.g.ZWSP))
                                            return re(o.previousElementSibling.lastElementChild, e, !1),
                        ...
                        if (c && "PRE" === c.tagName) {
                            ...
                            if (yt(e, t, c, n))
                                return !0;
                            if (("math-block" === u.getAttribute("data-type") || "html-block" === u.getAttribute("data-type")) && tt(e, t, n, u, c.parentElement))
                                return !0;
                            if (et(e, t, n, u, c.parentElement))
                                return !0
                        }
                        var p = (0,
                        ...
                        if (w) {
                            var E;
                            if (P("⌘=", t))
                                return (E = w.querySelector(".vditor-ir__marker--heading")) && E.textContent.trim().length > 1 && Tt(e, E.textContent.substr(1)),
                                t.preventDefault(),
                                !0;
                            if (P("⌘-", t))
                                return (E = w.querySelector(".vditor-ir__marker--heading")) && E.textContent.trim().length < 6 && Tt(e, E.textContent.trim() + "# "),
                                t.preventDefault(),
                                !0
                        }
                        var k = (0,
                    ...
                    d.yl)(t) && t.altKey && !t.shiftKey && /^Digit[1-6]$/.test(t.code)) {
                        if ("wysiwyg" === e.currentMode) {
                            ...
                            (0,
                            y.lG)(getSelection().getRangeAt(0).startContainer, n) ? ne(e) : te(e, n),
                            Y(e)
                        } else
                            "sv" === e.currentMode ? Ie(e, "#".repeat(parseInt(t.code.replace("Digit", ""), 10)) + " ") : "ir" === e.currentMode && Tt(e, "#".repeat(parseInt(t.code.replace("Digit", ""), 10)) + " ");
                        return t.preventDefault(),
                        !0
                    }
                    if ((0,
                    d.yl)(t) && t.altKey && !t.shiftKey && /^Digit[7-9]$/.test(t.code))
                        return "Digit7" === t.code ? ye(e, "wysiwyg", t) : "Digit8" === t.code ? ye(e, "ir", t) : "Digit9" === t.code && ye(e, "sv", t),
                        !0;
            ...
            t.addEventListener("selectstart", (function(n) {
                t.onmouseup = function() {
                    setTimeout((function() {
                        var t = we(e[e.currentMode].element);
            ...
            "wysiwyg" === e.currentMode ? Y(e, t) : "ir" === e.currentMode ? Mt(e, t) : "sv" === e.currentMode && Oe(e, t)
        }, dt = function(e, t, n, r) {
            ...
            if (l) {
                ...
                d.yl)(r) && !r.altKey && "Tab" === r.key) {
                    ...
                    s || "" !== e.toString())
                        return r.shiftKey ? it(t, l, e, l.parentElement) : rt(t, l, e),
                        r.preventDefault(),
                        !0
                }
            }
            ...
            if (n) {
                ...
                d.yl)(e) && !e.altKey && "Enter" === e.key) {
                    var i = String.raw(Z || (Z = Ke(["", ""], ["", ""])), n.textContent).replace(/\\\|/g, "").trim()
                      , o = i.split("|");
            ...
            if (i) {
                ...
                d.yl)(t) && !t.shiftKey && !t.altKey && "Backspace" === t.key && 0 === n.startOffset && "" === n.toString())
                    return !$e(i, n, !1) && a && ("" === a.textContent.trim() ? (a.outerHTML = '<p data-block="0"><wbr>\n</p>',
                    (0,
            ...
            D.Hc)(r),
            (0,
            d.vU)() || ("wysiwyg" === e.currentMode ? We(e, r) : R(e, r)),
            Te(e),
            t.preventDefault(),
            !0)
        }, bt = function(e, t, n, r) {
            ...
            return ze(void 0, void 0, void 0, (function() {
                ...
                return Ge(this, (function(E) {
                    ...
                    case 2:
                        ...
                        xe(e, e.lute.HTML2Md(f.innerHTML).trimRight())),
                        e.outline.render(e),
                        [3, 8]);
                    case 3:
                        return a.length > 0 ? e.options.upload.url || e.options.upload.handler ? [4, Ue(e, a)] : [3, 5] : [3, 7];
                    case 4:
                        return E.sent(),
                        [3, 6];
                    case 5:
                    ...
                    case 6:
                        return [3, 8];
                    case 7:
                        "" !== o.trim() && 0 === a.length && ("ir" === e.currentMode ? (l.Md2VditorIRDOM = {
                            renderLinkDest: s
                        },
                        e.lute.SetJSRenderers({
                            renderers: l
                    ...
                    case 8:
                        ...
                        st(e),
                        e[e.currentMode].element.scrollHeight - c > Math.min(e[e.currentMode].element.clientHeight, window.innerHeight) / 2 && Te(e),
                        [2]
                    }
                }
                ))
            ...
            if (t.classList.contains("vditor-menu--current"))
                if ("quote" === o) {
                    ...
                    "italic" === o ? At(i, e, "em") : "bold" === o ? At(i, e, "strong") : "strike" === o ? At(i, e, "s") : "inline-code" === o ? At(i, e, "code") : "check" !== o && "list" !== o && "ordered-list" !== o || (nt(e, i, o),
                    l = !1,
                    t.classList.remove("vditor-menu--current"));
            else {
                ...
                if ("line" === o) {
                    ...
                    f = void 0;
                    "" === i.toString() ? f = n + "<wbr>" + r : (f = "code" === o || "table" === o ? "" + n + i.toString() + "<wbr>" + r : "" + n + i.toString() + r + "<wbr>",
                    i.deleteContents()),
                    "table" !== o && "code" !== o || (f = "\n" + f + "\n\n");
                    ...
                    "check" !== o && "list" !== o && "ordered-list" !== o || (nt(e, i, o, !1),
                    l = !1,
                    c(e.toolbar.elements, ["check", "list", "ordered-list"]),
                    t.classList.add("vditor-menu--current"))
            }
            ...
            e.prototype.bindEvent = function(e) {
                ...
                this.element.addEventListener("click", (function(n) {
                    ...
                    if (!l || l.classList.contains("vditor-ir__node--expand")) {
                        ...
                        window.open(l.querySelector(":scope > .vditor-ir__marker--link").textContent)
                }
                )),
            ...
            return e.prototype.render = function(e) {
                ...
                jt.k)(e.preview.element.lastElementChild, this.element.lastElementChild, e) : (0,
                jt.k)(e[e.currentMode].element, this.element.lastElementChild, e)
            }
            ,
            e.prototype.toggle = function(e, t) {
                ...
                this.render(e),
                null == r || r.classList.add("vditor-menu--current")) : (this.element.style.display = "none",
                null == r || r.classList.remove("vditor-menu--current")),
                getSelection().rangeCount > 0) {
                    var o = getSelection().getRangeAt(0);
                    e[e.currentMode].element.contains(o.startContainer) ? (0,
                    D.Hc)(o) : e[e.currentMode].element.focus()
                }
                K(e)
            }
            ,
            e
        }(), Pt = n(207), qt = function() {
            function e(e) {
                var t = this;
                this.element = document.createElement("div"),
                ...
                n.addEventListener("click", (function(r) {
                    ...
                    y.fb)(i, "vditor-toc")) {
                        ...
                        "IMG" === r.target.tagName && (0,
                        B.E)(r.target, e.options.lang, e.options.theme)
                }
                ));
                ...
                for (var o = [], a = 0; a < r.length; a++) {
                    ...
                    if ("object" != typeof l)
                        ...
                        o.push('<button type="button" data-type="' + l.key + '" class="' + l.className + '"' + (l.tooltip ? ' aria-label="' + l.tooltip + '"' : "") + '">' + l.text + "</button>")
                }
                i.innerHTML = o.join(""),
                0 === r.length && (i.style.display = "none"),
                this.element.appendChild(i),
                this.element.appendChild(n),
                i.addEventListener((0,
                d.Le)(), (function(o) {
                    var a = (0,
                    b.S)(o.target, "BUTTON");
                    if (a) {
                        ...
                        s ? s.click(l) : "mp-wechat" !== l && "zhihu" !== l ? (n.style.width = "desktop" === l ? "auto" : "tablet" === l ? "780px" : "360px",
                        n.scrollWidth > n.parentElement.clientWidth && (n.style.width = "auto"),
                        t.render(e),
            ...
            return e.prototype.render = function(e, t) {
                ...
                "none" !== this.element.style.display)
                    if (t)
                        this.element.lastElementChild.innerHTML = t;
            ...
            e.prototype.afterRender = function(e, t) {
                ...
                (0,
                S.O)(e.preview.element.lastElementChild),
                (0,
                M.s)(e.options.preview.hljs, e.preview.element.lastElementChild, e.options.cdn),
                (0,
                A.i)(e.preview.element.lastElementChild, e.options.cdn, e.options.theme),
                (0,
                _.K)(e.preview.element.lastElementChild, e.options.cdn, e.options.theme),
                (0,
                L.P)(e.preview.element.lastElementChild, e.options.cdn),
                (0,
                C.v)(e.preview.element.lastElementChild, e.options.cdn),
                (0,
                k.p)(e.preview.element.lastElementChild, e.options.cdn, e.options.theme),
                (0,
                x.P)(e.preview.element.lastElementChild, e.options.cdn, e.options.theme),
                (0,
                H.B)(e.preview.element.lastElementChild, e.options.cdn),
                (0,
                E.Q)(e.preview.element.lastElementChild, e.options.cdn),
                (0,
                Pt.Y)(e.preview.element.lastElementChild);
                ...
                (0,
                T.H)(e.preview.element.lastElementChild, {
                    cdn: e.options.cdn,
                    math: e.options.preview.math
                })
            }
            ...
            return e.prototype.copy = function(e, t) {
                e.stopPropagation(),
                e.preventDefault(),
                e.clipboardData.setData("text/plain", we(t[t.currentMode].element))
            }
            ,
            e.prototype.bindEvent = function(e) {
                var t = this;
            ...
            function t(t, n) {
                ...
                d.Le)(), (function(e) {
                    ...
                    "sv" === t.currentMode && ("both" === t.options.preview.mode ? Wt("editor", t) : Wt("both", t)))
                }
                )),
                r
            }
            ...
            function t(t, n) {
                ...
                d.Le)(), (function(e) {
                    ...
                    (0,
                    Ft.Y)(e.target.textContent, t.options.cdn),
                    e.preventDefault(),
                    e.stopPropagation())
                }
                )),
            ...
            function t(t, n) {
                ...
                d.Le)(), (function(e) {
                    ...
                    (0,
                    U.Z)(t.options.preview.theme.current, t.options.preview.theme.path),
                    e.preventDefault(),
                    e.stopPropagation())
                }
                )),
            ...
            t.prototype._bindEvent = function(e, t) {
                ...
                d.Le)(), (function(r) {
                    ...
                    n.classList.contains("vditor-menu--current") ? ("wysiwyg" === e.currentMode ? (ne(e),
                    Y(e)) : "ir" === e.currentMode && Tt(e, ""),
                ...
                for (var r = 0; r < 6; r++)
                    ...
                    d.Le)(), (function(r) {
                        r.preventDefault(),
                        "wysiwyg" === e.currentMode ? (te(e, r.target.getAttribute("data-tag")),
                        Y(e),
                        n.classList.add("vditor-menu--current")) : "ir" === e.currentMode ? (Tt(e, r.target.getAttribute("data-value")),
                        n.classList.add("vditor-menu--current")) : Ie(e, r.target.getAttribute("data-value")),
            ...
            function t(t, n) {
                ...
                d.Le)(), (function(e) {
                    e.preventDefault(),
                    r.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t.currentMode || Xe(t, "afterend")
                }
                )),
                r
            }
            ...
            function t(t, n) {
                ...
                d.Le)(), (function(e) {
                    e.preventDefault(),
                    r.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t.currentMode || Xe(t, "beforebegin")
                }
                )),
                r
            }
                    ...
                    !n.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED)) {
                        ...
                        if (t)
                            ...
                            navigator.mediaDevices.getUserMedia({
                                ...
                                (t = new xn(r)).recorder.onaudioprocess = function(e) {
                                    if (t.isRecording) {
            ...
            function e(e) {
                ...
                e.options.counter.enable && (e.counter = new Qt(e),
            ...
            e.prototype.addCaret = function(e, t) {
                ...
                e.ir.element.cloneNode(!0).querySelectorAll(".vditor-" + e.currentMode + "__preview[data-render='1']").forEach((function(e) {
                    (e.firstElementChild.classList.contains("language-echarts") || e.firstElementChild.classList.contains("language-plantuml") || e.firstElementChild.classList.contains("language-mindmap")) && (e.firstElementChild.removeAttribute("_echarts_instance_"),
                    ...
                    e.firstElementChild.classList.contains("language-math") && (e.setAttribute("data-render", "2"),
            ...
            return e.prototype.merge = function() {
                ...
                (null === (n = this.options.hint) || void 0 === n ? void 0 : n.emoji) && (this.defaultOptions.hint.emoji = this.options.hint.emoji),
                this.options.comment && (this.defaultOptions.comment = this.options.comment));
                var r = (0,
                Un.T)(this.defaultOptions, this.options);
                if (r.cache.enable && !r.cache.id)
            ...
            e.prototype.bindEvent = function(e) {
                ...
                this.element.addEventListener("compositionend", (function(n) {
                    ...
                    d.vU)() || We(e, getSelection().getRangeAt(0).cloneRange(), n),
                    t.composingLock = !1)
                }
                )),
                this.element.addEventListener("input", (function(n) {
                    if ("deleteByDrag" !== n.inputType && "insertFromDrop" !== n.inputType) {
                        ...
                        if (t.composingLock || "‘" === n.data || "“" === n.data || "《" === n.data)
                            ...
                            i) {
                                ...
                                c && "" === c.textContent && (O(e),
                                c.remove()),
                                l && "code-block" !== i.getAttribute("data-type") || d || lt(i.innerHTML) || at(i.innerHTML) && i.previousElementSibling ? "function" == typeof e.options.input && e.options.input(a(e)) : We(e, r, n)
                            }
                        }
                    }
                }
                ...
                this.element.addEventListener("click", (function(n) {
                    ...
                    if ("IMG" !== n.target.tagName || n.target.parentElement.classList.contains("vditor-wysiwyg__preview")) {
                        "A" === n.target.tagName && window.open(n.target.getAttribute("href"));
                        var o = (0,
                        D.zh)(e);
                        if (n.target.isEqualNode(t.element) && t.element.lastElementChild && o.collapsed) {
                            ...
                            n.y > a.top + a.height && ("P" === t.element.lastElementChild.tagName && "" === t.element.lastElementChild.textContent.trim().replace(i.g.ZWSP, "") ? (o.selectNodeContents(t.element.lastElementChild),
                            o.collapse(!1)) : (t.element.insertAdjacentHTML("beforeend", '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"),
                            (0,
                            D.ib)(t.element, o)))
                        }
                        oe(e);
                        ...
                        "link-ref" === n.target.getAttribute("data-type") ? le(e, n.target) : function(e, t) {
                            var n = e.target;
                            ...
                            ;
                            var a = document.createElement("span");
                            a.setAttribute("aria-label", window.VditorI18n.alternateText),
                            ...
                            s.setAttribute("aria-label", window.VditorI18n.title),
                        ...
                        "ArrowDown" === t.key || "ArrowRight" === t.key || "Backspace" === t.key || "ArrowLeft" === t.key || "ArrowUp" === t.key) {
                            ...
                            if (r)
                                if ("none" !== r.previousElementSibling.style.display) {
                                    ...
                                    "ArrowDown" === t.key || "ArrowRight" === t.key ? re(r, e) : re(r, e, !1)
                        }
                    }
                }
                ))
        ...
        const Gn = function(e) {
            function t(t, n) {
                ...
                var o = new Wn(n).merge();
                if (o.i18n)
                    window.VditorI18n = o.i18n,
                    r.init(t, o);
                else {
                    if (!["en_US", "ja_JP", "ko_KR", "ru_RU", "zh_CN", "zh_TW"].includes(o.lang))
                        throw new Error("options.lang error, see https://ld246.com/article/1549638745630#options");
                    var a = "vditorI18nScript"
                      , s = a + o.lang;
                    document.querySelectorAll('head script[id^="' + a + '"]').forEach((function(e) {
            ...
            t.prototype.setTheme = function(e, t, n, r) {
                ...
                (0,
                U.Z)(t, r || this.vditor.options.preview.theme.path)),
                n && (this.vditor.options.preview.hljs.style = n,
                (0,
                Ft.Y)(n, this.vditor.options.cdn))
            }
            ,
            ...
            t.prototype.getSelection = function() {
                return "wysiwyg" === this.vditor.currentMode ? we(this.vditor.wysiwyg.element) : "sv" === this.vditor.currentMode ? we(this.vditor.sv.element) : "ir" === this.vditor.currentMode ? we(this.vditor.ir.element) : void 0
            }
            ,
            ...
            t.prototype.insertValue = function(e, t) {
                ...
                t && V(this.vditor)) : "wysiwyg" === this.vditor.currentMode ? (this.vditor.wysiwyg.preventInput = !0,
                t && We(this.vditor, getSelection().getRangeAt(0))) : "ir" === this.vditor.currentMode && (this.vditor.ir.preventInput = !0,
            ...
            t.prototype.setValue = function(e, t) {
                ...
                Oe(this.vditor, {
                    ...
                    enableHint: !1,
                    enableInput: !1
                })) : "wysiwyg" === this.vditor.currentMode ? fe(this.vditor, e, {
                    enableAddUndoStack: !0,
                    enableHint: !1,
                    enableInput: !1
            ...
            t.prototype.init = function(e, t) {
                ...
                this.vditor = {
                    ...
                    outline: new Rt(window.VditorI18n.outline),
                    tip: new Ut
                },
                this.vditor.sv = new Vt(this.vditor),
                this.vditor.undo = new Vn,
                this.vditor.wysiwyg = new Kn(this.vditor),
                this.vditor.ir = new Dt(this.vditor),
                this.vditor.toolbar = new qn(this.vditor),
                t.resize.enable && (this.vditor.resize = new Bt(this.vditor)),
                this.vditor.toolbar.elements.devtools && (this.vditor.devtools = new s),
                (t.upload.url || t.upload.handler) && (this.vditor.upload = new Ve),
                (0,
                l.G)(t._lutePath || t.cdn + "/dist/js/lute/lute.min.js", "vditorLuteScript").then((function() {
                    n.vditor.lute = (0,
                    It.X)({
                    ...
                    n.vditor.preview = new qt(n.vditor),
                    function(e) {
                        e.element.innerHTML = "",
                        ...
                        W(e),
                        (0,
                        U.Z)(e.options.preview.theme.current, e.options.preview.theme.path),
